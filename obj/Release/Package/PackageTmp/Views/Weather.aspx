        ...
        <tr>
            <td>
                <fieldset class="section">                        
                    ...
                    <label id="lblStation" runat="server" for="rbtnStation">Weather Station Using PRISM Data</label><br />
            ...
            <td id="tdWeather" runat="server" style="vertical-align: middle; text-align:left" >
                ...
                <fieldset id="fsetUploadWeatherFile" runat="server" style="display:none"  class="section">
                    ...
                    <%--<input id="Uploader" type="file" style="visibility:hidden;" onchange="setHiddenValue()" />--%>
                    <input runat="server" id="Hidden1" type="hidden" />
                    <asp:FileUpload ID="Uploader" runat="server" style="visibility:hidden;" onchange="setHiddenValue()"/>
                    <%--<asp:Label ID="lblOpen" Text="Click Browse to select the file and then Upload" runat="server"></asp:Label>--%>
                    <asp:Button ID="btnUploadWeatherFile" runat="server" Text="Upload Weather File" OnClientClick="triggerFileUpload()" OnClick="btnUploadWeatherFile_Click" ></asp:Button>
                </fieldset>
