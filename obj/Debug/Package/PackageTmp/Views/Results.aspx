...
//        }
        ...
        function turnOn(row) {
            ...
            for (i = rowIndex + 1; i < gridView.rows.length; i++) {
                if (gridView.rows[i].cells[gridView.rows[i].cells.length - 1].textContent == "Total") { break; }
                else {
        ...
        <table>
            <tr>
                ...
                <td>
                    <section id="sctFields" runat="server">
                        ...
                        <label id="lblScenario3" runat="server" class="label"></label>
                        <select id="ddlScenarios3" runat="server" onchange="__doPostBack();" ></select>
                    </section>
                    <section id="sctSubprojects" runat="server">
                        <label id="lblSubproject1" runat="server" class="label"></label>
                        <asp:DropDownList id="ddlSubproject1" runat="server" onchange="__doPostBack();"></asp:DropDownList>
                        <label id="lblSubproject2" runat="server" class="label"></label>
                        <asp:DropDownList id="ddlSubproject2" runat="server" onchange="__doPostBack();"></asp:DropDownList>
                        <label id="lblSubproject3" runat="server" class="label"></label>
                        <asp:DropDownList id="ddlSubproject3" runat="server" onchange="__doPostBack();"></asp:DropDownList>
                    </section>
                </td>
            </tr>
            <tr class="align-right" style="width:100%" >
                <td class="align-right" colspan="2">
                    ...
                    <asp:Button ID="DownloadDnDc" runat="server" Text="Download DnDc Files*" Enabled="false" style="margin:0,15,0,15"/>
                    <asp:Label ID="lblDownload" Text="* To Download and Create PDF you need to disable pop-up blockers" runat="server"/>
                </td>
            </tr>
        </table>
    </section>
    ...
    <section id="sctSummary" runat="server" class="section">
        <asp:GridView ID="gvResults" runat="server" AutoGenerateColumns="false" >
            ...
            <Columns>
                ...
                <asp:BoundField  DataField="Scenario1" ReadOnly="true" ItemStyle-HorizontalAlign="Right"><ItemStyle CssClass="leftBorder"/><HeaderStyle CssClass="leftBorder"/></asp:BoundField>
                <asp:BoundField  DataField="ci1" HeaderText="±" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField  DataField="Scenario2" ReadOnly="true" ItemStyle-HorizontalAlign="Right"><ItemStyle CssClass="leftBorder"/><HeaderStyle CssClass="leftBorder"/></asp:BoundField>
                <asp:BoundField  DataField="ci2" HeaderText="±" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField  DataField="Difference2" HeaderText="Difference" ReadOnly="true" ItemStyle-HorizontalAlign="Right"><ItemStyle CssClass="leftBorder"/><HeaderStyle CssClass="leftBorder"/></asp:BoundField>
                <asp:BoundField  DataField="Reduction2" HeaderText="Reduction (%)" ReadOnly="true" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                <asp:BoundField  DataField="TotalArea2" HeaderText="Total Area" ReadOnly="true" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                <asp:BoundField  DataField="Scenario3" ReadOnly="true" ItemStyle-HorizontalAlign="Right"><ItemStyle CssClass="leftBorder"/><HeaderStyle CssClass="leftBorder"/></asp:BoundField>
                <asp:BoundField  DataField="ci3" HeaderText="±" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField  DataField="Difference3" HeaderText="Difference" ReadOnly="true" ItemStyle-HorizontalAlign="Right"><ItemStyle CssClass="leftBorder"/><HeaderStyle CssClass="leftBorder"/></asp:BoundField>
                <asp:BoundField  DataField="Reduction3" HeaderText="Reduction (%)" ReadOnly="true" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                <asp:BoundField  DataField="TotalArea3" HeaderText="Total Area" ReadOnly="true" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
                <asp:BoundField  DataField="Type" HeaderText="" ReadOnly="true" ></asp:BoundField>
            </Columns>
        </asp:GridView>
        <label id="lblCI" runat="server" class="label" >(±) Confidence Interval</label>
    </section>
        ...
        <fieldset id="fsetChart" runat="server">
            ...
            <asp:Chart ID="Chart1" runat="server" Width="771px">
                <Series>
                    ...
                    <asp:Series ChartArea="ChartArea1" Name="Series3" Legend="Legend1" XValueType="String" YValueType="Single">
                        <Points>
                            <asp:DataPoint XValue="1" YValues="50" />
                            <asp:DataPoint XValue="2" YValues="60" />
                            <asp:DataPoint XValue="3" YValues="70" />
