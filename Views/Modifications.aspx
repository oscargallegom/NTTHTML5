...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input id="btnDownloadAPEX1" runat="server" type="button" value="Download APEX folder" onclick="__doPostBack('btnDownloadAPEX', 'btnDownloadAPEX')"/>
    <asp:LinkButton ID="btnSaveContinue" runat="server" Text="Save Modifications"></asp:LinkButton>
    
    <fieldset id="fsetControlfile" runat="server" class="section">
        <legend id="lblControl" runat="server">Control File</legend>
        <input id="btnDefaultControl" runat="server" type="button" value="Reset to Default" onclick="__doPostBack('btnDefaultControl', 'btnDefaultControl')"/>
    ...
    <fieldset id="fsetParamfile" runat="server" class="section">        
        <legend id="lblParmFile" runat="server">Parameters File</legend>
        <input id="btnDefaultParms" runat="server" type="button" value="Reset to Default" onclick="__doPostBack('btnDefaultParms', 'btnDefaultParms')"/>
                                    ...
                                    <asp:GridView ID="gvLine2" runat="server" AutoGenerateColumns="false">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Inps">
                                                <ItemTemplate>
                                                    <input id="txtInps" value='<%#Eval("inps")%>' runat="server" class="gvTextBoxSmall" readonly="readonly"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Iops" >
                                                <ItemTemplate>
                                                    <input id="txtIops" value='<%#Eval("iops")%>' runat="server" class="gvTextBoxSmall" readonly="readonly"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Iow" >
                                                <ItemTemplate>
                                                    <input id="txtIow" value='<%#Eval("iow")%>' runat="server" class="gvTextBoxSmall" readonly="readonly"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="LineNumber" HeaderText="Line #" ReadOnly="true" /> 
                                             <asp:TemplateField HeaderText="Wsa" >
                                                <ItemTemplate>
                                                    <input id="txtWsa" value='<%#Eval("wsa")%>' runat="server" class="gvTextBoxMedium" />
                                                </ItemTemplate>
                                             </asp:TemplateField>
                                             <asp:TemplateField HeaderText="chl" >
                                                <ItemTemplate>
                                                    <input id="txtChl" value='<%#Eval("chl")%>' runat="server" class="gvTextBoxMedium" />
                                                </ItemTemplate>
                                             </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="Slp" >
                                                <ItemTemplate>
                                                    <input id="txtSlp" value='<%#Eval("slp")%>' runat="server" class="gvTextBoxMedium" />
                                                </ItemTemplate>
                                             </asp:TemplateField>
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="LineNumber" HeaderText="Line #" ReadOnly="true" /> 
                                             <asp:TemplateField HeaderText="Rchl" >
                                                <ItemTemplate>
                                                    <input id="txtRchl" value='<%#Eval("rchl")%>' runat="server" class="gvTextBoxMedium" />
                                                </ItemTemplate>
                                             </asp:TemplateField>
    ...
    <fieldset id="fsetSoilfile" runat="server" class="section">
        ...
        <asp:GridView id="gvSoils" runat="server" AutoGenerateColumns="false"  >
            ...
            <HeaderStyle CssClass="gvHeaderStyle" />
                <Columns>
                 <asp:BoundField  DataField="name" HeaderText="Name" ReadOnly="true" ></asp:BoundField>
                 <asp:BoundField  DataField="soilNumber" HeaderText="Soil #" ReadOnly="true" ItemStyle-CssClass="gvTextBoxSmall"></asp:BoundField>
            ...
            <HeaderStyle CssClass="gvHeaderStyle" />
                ...
                <asp:TemplateField HeaderText="Year" >
                 ...
                 <asp:TemplateField HeaderText="JX(7)/id" >
                    <ItemTemplate>
                        <input id="txtApexOpType" value='<%#Eval("apexoptype")%>' runat="server" class="gvTextBoxSmall" />
                    </ItemTemplate>
                 </asp:TemplateField>
                <asp:TemplateField HeaderText="OPV1" >
                    <ItemTemplate>
                        <input id="txtOpVal1" value='<%#Eval("opval1")%>' runat="server" class="gvTextBoxMedium" />
                    </ItemTemplate>
                 </asp:TemplateField>
