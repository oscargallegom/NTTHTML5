...
//        $(function () {
//            $('#btnCopyFarm').click(function () {
//                //Create a Dialog (modal)
//                $("#dialog-modal").dialog({ 
//                modal: true,
//                width: 600, 
//                closeText: 'Hide',
//                title: "Create Field from Farm" 
//                });
//            });
//        });
        ...
        function setSelection(shape) {
            ...
            if (document.getElementById("polyTypeField").checked) {
                ...
                google.maps.event.addListener(shape.getPath(), 'remove_at', function () {
                    ...
                    var intIndex = strTempInfo[0].indexOf(":");
                    var strTempDeletePolyName = strTempInfo[0].substring(intIndex + 1).replace(/^\s+|\s+$/g, '');
                    for (var j = 0; j < arrayFieldsNames.length; j++) {if (strTempDeletePolyName == arrayFieldsNames[j].replace(/^\s+|\s+$/g, '')) {
                            var areaPolyTemp = google.maps.geometry.spherical.computeArea(shape.getPath());
                            arrayFieldsArea[j] = areaPolyTemp;
                        }
                    }
                    ...
                    <td>
                        <table class="tableStyle" id="tblSelectAOI">
                            ...
                            <tr style="border-top:1; border-top-color:Black; border-top-style: solid; border-top-width: thin;">
                                <td colspan="2" style="border-style: solid none none none; border-width: thin"><label id="lblNote5" runat="server"/>If you want to copy a field from a farm and there are fields in this map they will be removed and a new field equal to the farm polygon will be created.</td>
                            </tr>
                            <tr>
                                <td>
